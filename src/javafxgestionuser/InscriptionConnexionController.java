...
import gui.Postulation1Controller;
...
//el admine aando deja el email ou pwd b7okm howa aabed barka
        ...
        } else if (connexion_email.getText().equals("nourRes@gmail.com") && connexion_mot_de_passe.getText().equals("root")) {

            try {
                //ki nda5al bes7i7 el email wel pwd ihezeni lel dashboard ta3o
                System.out.println("El email taa el login" + connexion_email.getText());
                System.out.println("El email taa el login" + connexion_email.getText());
                System.out.println("El pwd taa el login" + connexion_mot_de_passe.getText());
                System.out.println("El pwd taa el login" + connexion_mot_de_passe.getText());
                System.out.println("El pwd taa el login" + connexion_mot_de_passe.getText());
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/postulation1.fxml"));
                Parent root = loader.load();
                cnxbutton.getScene().setRoot(root);
            } catch (IOException ex) {
                Logger.getLogger(InscriptionConnexionController.class.getName()).log(Level.SEVERE, null, ex);
...
//hedheya systeme de suspension (suspendre fi wa9t mou3ayan) tsir wa9telli le mot de passe 8alat
            ...
            try {
                ...
                alert.setHeaderText("Vous etes le bienvenue");
                 alert.setContentText("Vous étes"+u.getNom()+" "+u.getPassword());
                alert.showAndWait();
